...
namespace ClinicaApp.Controllers
{
    public class DoctoresController : Controller
    {
        ...
        public DoctoresController(ClinicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,Nombre,Especialidad,Telefono,Estado")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,Nombre,Especialidad,Telefono,Estado")] Doctor doctor)
        {
